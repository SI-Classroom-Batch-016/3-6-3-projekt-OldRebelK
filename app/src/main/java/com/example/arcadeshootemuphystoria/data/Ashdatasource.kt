...
object Ashdatasource {
    ...
    val info: List<AshInfoFragData> = listOf(
        AshInfoFragData("Axelay wurde 1992 von Konami entwickelt und für die SuperNintendo Rausgebracht." +
                "Es ist sowohl ein Horizontal als auch Vertikal Shoot em up  und einer der ersten das damals Mode 7 verwendet hat." +
                "Mit einen recht einzigartigen  Soundtrack und einen innovativen Waffensystem wurde Axelay einer der beliebtererin titel auf der SNES.",R.drawable.axelay1,R.drawable.axelay2),
